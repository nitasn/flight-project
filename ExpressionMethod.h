...
class UPlus: public UnaryOpertor {
protected:Expression *uPlus;
public: UPlus(Expression *uPlus);
public: double calculate();
};


class UMinus: public UnaryOpertor {
protected:Expression *uMinus;
public: UMinus(Expression *uMinus);
    double calculate();
};
