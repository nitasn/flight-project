...
//}
///**
// * parser run on the queue map and do play the command
// */
...
////    this->commandMap.insert(make_pair("Sleep",));
////    this->commandMap.insert(make_pair("while",));
////    this->commandMap.insert(make_pair("if",));
//}